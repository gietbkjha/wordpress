...
*/
	...
	class BOOKING_PACKAGE {
		...
		public $dataRetentionPeriod = 0;
		
		public $syncPastCustomersForIcal = 0;
		...
		**/
		...
		public function bookingPageForVisitors($atts) {
			...
			**/
			...
			$html .= '<a id="booking-package-subscribed" class="edit">Subscribed items</a>';
			$html .= '</div>';
		...
		public function localizeScript($mode){
			...
			if ($mode == 'adomin') {
				...
				if ($this->dataRetentionPeriod == 0) {
					...
					unset($list['General'][$this->prefix . 'dataRetentionPeriod']);
