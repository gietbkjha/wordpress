            ...
            <div class="container-fluid">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                        ...
                        <div class="tm-footer-content-box">
                            ...
                            <div class="tm-margin-b-30">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/tm-img-100x100-1.jpg" alt="Image" class="tm-footer-thumbnail">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/tm-img-100x100-2.jpg" alt="Image" class="tm-footer-thumbnail">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/tm-img-100x100-3.jpg" alt="Image" class="tm-footer-thumbnail">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/tm-img-100x100-4.jpg" alt="Image" class="tm-footer-thumbnail">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/tm-img-100x100-5.jpg" alt="Image" class="tm-footer-thumbnail">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/tm-img-100x100-6.jpg" alt="Image" class="tm-footer-thumbnail">
                            </div>
                ...
                <div class="row">
                    <div class="col-xs-12 tm-copyright-col">
                        <p class="tm-copyright-text"><?php echo ot_get_option('classic_copyright_text'); ?></p>
                    </div>
                </div>
            </div>
        </footer>
